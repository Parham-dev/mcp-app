...
export const appId = "budget-allocator";
export const appName = "Budget Allocator";
export const appDescription = "Interactive budget allocation tool with real-time data visualization";

// Path to the built HTML file
const HTML_PATH = path.join(import.meta.dirname, "../../dist/apps/budget-allocator/mcp-app.html");
